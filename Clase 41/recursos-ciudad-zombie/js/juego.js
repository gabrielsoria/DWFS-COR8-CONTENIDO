...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/auto_verde_abajo.png', 175, 230, 15, 30, 1),

    new Obstaculo('imagenes/valla_vertical.png', 190, 460, 30, 30, 1),
    //x: 130,
    //y: 160,
    //new Obstaculo('imagenes/bache.png', 70, 430, 30, 30, 1)
  ...
  enemigos: [
    new ZombieConductor('imagenes/zombie1.png', 200, 300, 10, 10, 5, {desdeX: 50, hastaX: 960, desdeY: 0, hastaY: 0}, 'h'),
    new ZombieConductor('imagenes/zombie2.png', 400, 300, 10, 10, 8, {desdeX: 50, hastaX: 960, desdeY: 50, hastaY: 500}, 'v'),
    new ZombieCaminante('imagenes/zombie2.png', 400, 300, 10, 10, 8, {desdeX: 50, hastaX: 960, desdeY: 50, hastaY: 500})
  ]
...
Juego.capturarMovimiento = function(tecla) {
  ...
  if (tecla == 'izq') {
    movX = -velocidad;
    sprit = 'imagenes/auto_rojo_izquierda.png';
  }
  if (tecla == 'arriba') {
    movY = -velocidad;
    sprit = 'imagenes/auto_rojo_arriba.png';
  }
  if (tecla == 'der') {
    movX = velocidad;
    sprit = 'imagenes/auto_rojo_derecha.png';
  }
  if (tecla == 'abajo') {
    movY = velocidad;
    sprit = 'imagenes/auto_rojo_abajo.png';
  }
  ...
  if (this.chequearColisiones(movX + this.jugador.x, movY + this.jugador.y)) {
    ...
    /* COMPLETAR */
    this.jugador.mover(movX, movY, sprit);
  }
};
...
Juego.chequearColisiones = function(x, y) {
  ...
  this.obstaculos().forEach(function(obstaculo) {
    if (this.intersecan(obstaculo, this.jugador, x, y)) {
      ...
      console.log("COLISION!!!! vidas del jugador: ", this.jugador.vidas);
      obstaculo.colisionar(this.jugador);
      console.log("COLISION pasada!!!! vidas ahora: ", this.jugador.vidas);
...
Juego.dibujarFondo = function() {
  ...
  Dibujante.dibujarRectangulo('yellow', 760, 500, 130, 50);
};
